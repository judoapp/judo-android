...
package app.judo.sdk.ui.models.messages
...
class GetExperienceForScreenRequest(
    val screenID: String,
    val response: CompletableDeferred<Response> = CompletableDeferred()
) {
    data class Response(
        val experience: Experience,
        val dataContext: DataContext = emptyDataContext(),
        val authorizersOverride: List<Authorizer>? = null
    )
}