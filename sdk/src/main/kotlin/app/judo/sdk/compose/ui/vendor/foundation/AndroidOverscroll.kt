...
import app.judo.sdk.compose.ui.modifiers.layoutWithIntrinsicsPassthrough

import app.judo.sdk.compose.ui.vendor.foundation.EdgeEffectCompat.distanceCompat
import app.judo.sdk.compose.ui.vendor.foundation.EdgeEffectCompat.onAbsorbCompat
import app.judo.sdk.compose.ui.vendor.foundation.EdgeEffectCompat.onPullDistanceCompat
...
internal class AndroidEdgeEffectOverscrollEffect(
    ...
    init {
        allEffects.forEach { it.color = overscrollConfig.glowColor.toArgb() }
    }
    ...
    override val isInProgress: Boolean
        get() {
            return allEffects.any { it.distanceCompat != 0f }
        }
...
private val StretchOverscrollNonClippingLayer: Modifier =
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
        Modifier
            // JUDO: replaced .layout() with .layoutWithIntrinsicsPassthrough().
            .layoutWithIntrinsicsPassthrough { measurable, constraints ->
