...
internal data class AppBar(
     ...
     */
    val buttonColor: ColorReference,
    /**
    ...
    override fun setRelationships(
        ...
        this.titleColor.setRelationships(documentColors)
        this.backgroundColor.setRelationships(documentColors)
        this.buttonColor.setRelationships(documentColors)
    }
}
